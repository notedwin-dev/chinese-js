export enum TokenType {
  ...
  Punctuation,
  EOF, // End of file
  FunctionName, // New token type for function name
  FunctionParams, // New token type for function parameters
  FunctionBody, // New token type for function body
  FunctionCall, // New token type for function call
  Console, // New token type for console
  SingleLineComment, // New token type for single-line comments
  MultiLineComment, // New token type for multi-line comments
}
...
export class Lexer {
  ...
  private operatorOrPunctuation(): Token | null {
  ...
  private functionDefinition(): Token {
    let value = "function ";
    let name = "";
    let params = "";
  ...
  private functionCall(funcName: string): Token {
    let value = "";
  ...
  private singleLineComment(): Token {
    let value = "//";
  ...
  public nextToken(): Token {
    ...
    if (this.isAlpha(char)) {
      ...
      if (
        identifier.type === TokenType.Keyword &&
  ...
  public translate(tokens: Token[]): string {
    let result = "";
